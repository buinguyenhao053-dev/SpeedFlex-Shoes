import { womenProducts } from "../js/products.js";
...
const categoryFilters = [
  "all",
  ...new Set(womenProducts.map((product) => product.category)),
];
const sizeFilters = [
  "all",
  ...new Set(womenProducts.flatMap((product) => product.sizes)),
].sort((a, b) => {
  if (a === "all") return -1;
  if (b === "all") return 1;
  return a - b;
...
function renderFilterButtons(
  ...
  container.querySelectorAll("button").forEach((button) => {
    button.addEventListener("click", () => clickHandler(button.dataset.value));
  });
}
                    ...
                    <article class="product-card">
                        ...
                        <div class="product-info">
                            ...
                            <div class="product-actions">
                                ...
                                <a href="detail.html?id=${product.id}&source=women" class="add-btn">Xem chi tiết</a>
                            </div>
                        </div>
                    </article>
                `;
